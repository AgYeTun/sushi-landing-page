...
const AboutUs = () => {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-11 gap-12 md:gap-0 max-w-screen-md mx-auto py-10">
        <img className="absolute rotate-[-15deg] right-4 -bottom-[100%] md:-bottom-[0%] w-24 opacity-30 z-0" src="../src/assets/img/leaf-branch-1.png" alt="" />
        ...
        <div className="md:col-span-5 order-1 md:order-2 flex flex-col items-center md:items-start text-center md:text-start gap-2 md:gap-4 mt-6 px-6 md:px-0">
