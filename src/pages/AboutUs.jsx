...
const AboutUs = () => {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-11 gap-12 md:gap-0 max-w-screen-md mx-auto py-16 px-6">
        ...
        <div className="md:col-span-5 order-1 md:order-2 flex flex-col items-center md:items-start text-center md:text-start gap-2 md:gap-4 mt-6  md:px-0">
