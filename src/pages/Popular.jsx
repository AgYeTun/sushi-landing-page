...
const Popular = () => {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 max-w-screen-md mx-auto py-16 px-6">
        ...
        <div className="md:col-span-1 mx-auto w-64 md:w-56 shadow-xl rounded-lg bg-body-color-alt md:my-12 text-center group relative">
          <img className='w-60 md:w-52 -translate-y-4 group-hover:-translate-y-6 mx-auto' src="../src/assets/img/popular-onigiri.png" alt="" />
        ...
        <div className="md:col-span-1 mx-auto w-64 md:w-56 shadow-xl rounded-lg bg-body-color-alt md:my-12 text-center group relative">
          <img className='w-60 md:w-52 -translate-y-4 group-hover:-translate-y-6 mx-auto' src="../src/assets/img/popular-spring-rols.png" alt="" />
        ...
        <div className="md:col-span-1 mx-auto w-64 md:w-56 shadow-xl rounded-lg bg-body-color-alt md:my-12 text-center group relative">
          <img className='w-60 md:w-52 -translate-y-4 group-hover:-translate-y-6 mx-auto' src="../src/assets/img/popular-sushi-rolls.png" alt="" />
